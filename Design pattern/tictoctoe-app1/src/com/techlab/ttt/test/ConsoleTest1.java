...
public class ConsoleTest1 {
	public static void main(String args[]) throws CellIsAlredyMarkedException, CellIndexOutOfBound {
		...
		// while (GameStatus.INPROGRESS != null) {
		System.out.println("Anjali's will play first. Enter a slot number to place X in:");
		int cellnumber1 = sc.nextInt();

		game.makeMove(player1, cellnumber1);
		game.displayBoard();

		System.out.println("Sonam's will play second. Enter a slot number to place O in:");
